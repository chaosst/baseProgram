...
<template>
  ...
  <div class="warehouseMain">
    <!--<el-row>-->
        <fant-table ref="editTable" :data="mydata" :opt="tableOpt" :columns="columns" @cell-mouse-enter="hoverRow" @cell-mouse-leave="leaveRow" >
    ...
    <el-row>
      ...
      <cascader :opt="casOpt" @change="myclose" v-model="editData.inWareHouseId" style="width:100%;">
      </cascader>
      </fant-form-item>
      </el-col>
      <el-col :span="6">
...
//          url:"member/vagueSearch",
    ...
    methods:{
      ...
      close:function(){
        ...
        this.$router.push("/main/platformManage");
      },
      addRow(e,index){
